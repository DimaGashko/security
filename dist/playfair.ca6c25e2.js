...
"use strict";var e=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(exports,"__esModule",{value:!0}),require("normalize.scss/normalize.scss"),require("./index.scss");var r=e(require("lodash/template")),n=e(require("./scripts/algorithms/playfair/PlayfairGrid")),t=require("./scripts/algorithms/playfair");window.encode=t.encode,window.decode=t.decode;var o="cluster",i=document.querySelector(".app"),a=i.querySelector(".actions__auth"),s=i.querySelector(".actions__decode"),u=i.querySelector(".db__content"),d=i.querySelector(".user-tmpl"),c=i.querySelector(".add"),l=c.login,f=c.pwd,p=c.about,v=n.default.createEnGrid(o),g="users"in localStorage?JSON.parse(localStorage.users):[],w=r.default(d.innerHTML);function m(){a.addEventListener("click",function(){y()}),s.addEventListener("click",function(){S()}),c.addEventListener("submit",function(e){e.preventDefault(),_()})}function y(){var e=prompt("Login",""),r=prompt("Password",""),n=g.find(function(r){var n=r.login;return e===n});n?t.encode(r,v)===n.pwd?alert("Success!\nLogin: "+e+"\nAbout: "+n.about):alert("Wrong password!"):alert("User not found")}function S(){var e=prompt("Login",""),r=g.find(function(r){var n=r.login;return e===n});if(r){var n=t.decode(r.pwd,v);alert("Login: "+e+"\nEncoded password: "+r.pwd+"\nDecoded password: "+n)}else alert("User not found")}function _(){var e=l.value.trim(),r=t.encode(f.value.trim(),v),n=p.value.trim();g.find(function(r){var n=r.login;return e===n})?alert("User already exist"):(q({login:e,pwd:r,about:n}),L(),c.reset(),l.focus())}function q(e){g.push(e),localStorage.users=JSON.stringify(g)}function L(){u.innerHTML=w({users:g})}window.grid=v,window.urers=g,L(),m();
...
//# sourceMappingURL=../playfair.ca6c25e2.js.map