...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../../node_modules/lodash/_baseSlice.js":[function(require,module,exports) {
/**
...
function decode(msg, key) {
  return process(msg, math_1.modInvMat(prepareKey(key), Math.pow(2, 16)));
}
...
console.log(encoded);
console.log('-------');
console.log(hill_1.decode(encoded, 'do_you_love_code_so_much?'));
initEvents();
